...
export const contentAnalysisSchema = z.object({
  ...
  readingScope: z.enum(["metadata_only", "provided_text", "public_page"]).optional(),
  retrieval: z.object({ finalUrl: z.string(), retrievedAt: z.string(), availableCharacters: z.number(), analyzedCharacters: z.number() }).optional(),
