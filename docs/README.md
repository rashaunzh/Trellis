...
文档分为当前产品规则、下一版设计、实现状态与工程操作。设计完成不等于功能完成，旧截图不代表新版验收。

## 从这里开始

1. [产品契约](product/TRELLIS_COURSE_INTELLIGENCE_PRODUCT_CONTRACT.md)：当前承诺与非目标。
2. [产品设计决策](product/TRELLIS_PRODUCT_ANALYSIS_2026-09-14.md)：第 0 节定义完整性门，第 2 节需求追溯，第 13 节竞品，第 20–21 节内容分层和 AI/价值验收；[桌面交互规格](product/TRELLIS_DESKTOP_UPDATE_DESIGN_2026-09-14.md)：第 3–13 节学习流程，第 18–23 节路由、原子操作、连续内容稿、迁移与验收。两份均为 2026-09-15 可实施规格版；文档可审阅不等于原型或用户效果通过，手机专项后置。
