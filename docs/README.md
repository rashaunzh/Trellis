...
- `archive/legacy-v0.1/` 保存 Trellis 定名与 V0.2 方向确认前的材料。其旧名称、状态和决策均不是当前基线。
- `archive/2026-08-13-mvp-proposals/` 保存 2026-08-13 的 MVP 提案（PRD 与架构），已被当前 PRD 与 V0.2 架构取代，仅供追溯。
